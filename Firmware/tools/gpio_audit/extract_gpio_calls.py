...
class GPIOVisitor(ast.NodeVisitor):
    ...
    visit_AsyncFunctionDef = visit_FunctionDef  # noqa: N815 — AST visitor convention
    ...
    def visit_Call(self, node):
        ...
        if is_gpio_call:
            ...
            kwargs_str = {kw.arg: self._stringify_node(kw.value) for kw in node.keywords if kw.arg}
            self.calls.append(
                {
                    "file": self.filepath,
                    "line": node.lineno,
