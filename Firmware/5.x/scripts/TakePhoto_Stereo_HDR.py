...
from mothbox_paths import CAMERA_SETTINGS_FILE, CONTROLS_FILE, PHOTOS_DIR
...
capture_main = {
    "size": (4624, 3472),
    "format": "RGB888",
}  # dual can do #The resolution can't be 9152 x 6944 for dual camera or else we get a crash on a pi5, but it can do lower
...
computerName = camera_settings.pop(
    "Name", computerName
...
def takePhoto_Manual():
    ...
    for img in PILs:
        ...
        zeroth_ifd = {
            piexif.ImageIFD.Make: "MothboxV3",
        }
