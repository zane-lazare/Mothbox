...
export interface PhotoListItemPhoto {
  path: string
  filename: string
  date: string
  size?: number
...
export interface PhotoListItemProps {
  photo: PhotoListItemPhoto
  onClick?: (photo: PhotoListItemPhoto) => void
  index?: number
  photos?: PhotoListItemPhoto[]
}
 ...
 */
function PhotoListItem({ photo, onClick, index, photos }: PhotoListItemProps) {
