...
try:
    ...
    font10 = ImageFont.truetype(
        str(MOTHBOX_HOME / "graphics/fonts/Roboto/static/Roboto-Bold.ttf"), 10
    )
    font7 = ImageFont.truetype(
        str(MOTHBOX_HOME / "graphics/fonts/Roboto/static/Roboto-Bold.ttf"), 7
    )

    font_bigs = ImageFont.truetype(
        str(MOTHBOX_HOME / "graphics/fonts/bigshoulders/BigShoulders-Bold.ttf"), 12
    )
    ...
    font_robotosemicon10 = ImageFont.truetype(
        str(MOTHBOX_HOME / "graphics/fonts/Roboto/static/Roboto_SemiCondensed-Bold.ttf"), 11
    )
    font_roboto = ImageFont.truetype(
        str(MOTHBOX_HOME / "graphics/fonts/Roboto/static/Roboto-Regular.ttf"), 16
    )
    font_roboto15 = ImageFont.truetype(
        str(MOTHBOX_HOME / "graphics/fonts/Roboto/static/Roboto-Regular.ttf"), 15
    )

    font_roboto10 = ImageFont.truetype(
        str(MOTHBOX_HOME / "graphics/fonts/Roboto/static/Roboto-Regular.ttf"), 10
    )
    ...
    draw.text(
        (2, 47),
        time.strftime("%Y-%m-%d %H:%M", time.localtime(nexttime)),
        font=font_roboto15,
        fill=0,
    )
    ...
    # Battery Stuff
    if voltage == -100:
        draw.text((2, 205), "BATTERY: UNKNOWN", font=font10, fill=0)
    else:
        draw.text((2, 205), f"BATTERY: {percent:.0f}%", font=font10, fill=0)

    draw.text((2, 215), "last update: ", font=font10, fill=0)
    draw.text(
        (2, 225), time.strftime("%m-%d %H:%M:%S") + " UTC:" + str(UTCoff), font=font10, fill=0
    )
