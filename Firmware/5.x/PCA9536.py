...
class PCA9536:
    ...
    def input_output_config(self):
        ...
        if self.io == 0:
            if self.pin == 0:
                bus.write_byte_data(
                    PCA9536_DEFAULT_ADDRESS, PCA9536_REG_CONFIG, PCA9536_CONFIG_PIN0
                )
            elif self.pin == 1:
                bus.write_byte_data(
                    PCA9536_DEFAULT_ADDRESS, PCA9536_REG_CONFIG, PCA9536_CONFIG_PIN1
                )
            elif self.pin == 2:
                bus.write_byte_data(
                    PCA9536_DEFAULT_ADDRESS, PCA9536_REG_CONFIG, PCA9536_CONFIG_PIN2
                )
            elif self.pin == 3:
                bus.write_byte_data(
                    PCA9536_DEFAULT_ADDRESS, PCA9536_REG_CONFIG, PCA9536_CONFIG_PIN3
                )
        elif self.io == 1:
    ...
    def polarity_config(self):
        ...
        if self.pin == 0:
            bus.write_byte_data(
                PCA9536_DEFAULT_ADDRESS, PCA9536_REG_POLARITY, PCA9536_POLARITY_PIN0
            )
        elif self.pin == 1:
            bus.write_byte_data(
                PCA9536_DEFAULT_ADDRESS, PCA9536_REG_POLARITY, PCA9536_POLARITY_PIN1
            )
        elif self.pin == 2:
            bus.write_byte_data(
                PCA9536_DEFAULT_ADDRESS, PCA9536_REG_POLARITY, PCA9536_POLARITY_PIN2
            )
        elif self.pin == 3:
            bus.write_byte_data(
                PCA9536_DEFAULT_ADDRESS, PCA9536_REG_POLARITY, PCA9536_POLARITY_PIN3
            )
